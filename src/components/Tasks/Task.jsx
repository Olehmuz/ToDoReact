...
const Task = ({id, text, listId, onEdit, onRemove, completed, onCompletedToggle }) => {
  const onToggleCheck = (e) => {
    onCompletedToggle(listId, id, e.target.checked);
  }
  return (
    <div className="checkbox" key={id}>
      <input checked={completed} onChange={onToggleCheck} id={`task-${id}`} type="checkbox" />
      ...
      <div className="tasks__content">{text}</div>
      <div className="tasks__actions">
          <div className="tasks__edit" onClick={() => onEdit(listId, {id, text})}>
          ...
          <div className="tasks__delete" onClick={() => onRemove(listId, id)}>
